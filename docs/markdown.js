;(function (exports) {
    ...
    function K(e, n) {
        return (function (e, n) {
            var t, r, o, i
            if (!y)
                for (y = new WeakMap(), t = 0; t < _.length; t++)
                    (r = _.get(t)) && y.set(r, t)
        ...
        (function () {
            ...
            function t(e, t) {
                ...
                ;(n.asm = o),
                    ...
                    (function (e) {
                        if (
                            (I--,
                            n.monitorRunDependencies &&
                                n.monitorRunDependencies(I),
                            0 == I &&
            ...
            'function' != typeof fetch
                ...
                : fetch(L, { credentials: 'same-origin' }).then(function (n) {
                      return WebAssembly.instantiateStreaming(n, e).then(
                          r,
                          function (e) {
                              return (
            ...
            let o = n.onCodeBlock
                ? ((i = n.onCodeBlock),
                  K(function (e, n, t, r, o) {
                      try {
                          const u =
                                  n > 0 ? ne.decode(A.subarray(e, e + n)) : '',
                              a = A.subarray(t, t + r)
                          let s = void 0
                          ...
                          return (
                              console.error(
                                  `error in markdown onCodeBlock callback: ${
                                      e.stack || e
                                  }`
                              ),
                              -1
