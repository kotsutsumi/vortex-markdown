...
render_open_td_block(JsonFormatter *r, const MD_CHAR *cell_type, const MD_BLOCK_TD_DETAIL *det)
{
  ...
  {
  case MD_ALIGN_LEFT:
    WBufAppendCStr(r->outbuf, " align=\"left\">");
    break;
  case MD_ALIGN_CENTER:
    WBufAppendCStr(r->outbuf, " align=\"center\">");
    break;
  case MD_ALIGN_RIGHT:
    WBufAppendCStr(r->outbuf, " align=\"right\">");
    break;
  default:
    WBufAppendCStr(r->outbuf, ">");
    break;
...
#define WRITE_TYPE_START(name) writeTypeStart(r, (name), strlen((name)))
  ...
  {
  case MD_BLOCK_DOC:
    WRITE_TYPE_START("doc");
    break;
  case MD_BLOCK_QUOTE:
    WRITE_TYPE_START("quote");
    break;
  case MD_BLOCK_UL:
    WRITE_TYPE_START("ul");
    break;
  case MD_BLOCK_HTML:
    WRITE_TYPE_START("html");
    break;
  case MD_BLOCK_P:
    WRITE_TYPE_START("p");
    break;
  case MD_BLOCK_TABLE:
    WRITE_TYPE_START("table");
    break;
  case MD_BLOCK_THEAD:
    WRITE_TYPE_START("thead");
    break;
  case MD_BLOCK_TBODY:
    WRITE_TYPE_START("tbody");
    break;
  case MD_BLOCK_TR:
    WRITE_TYPE_START("tr");
    break;
...
static int enter_span_callback(MD_SPANTYPE type, void *detail, void *userdata)
{
  ...
  {
  case MD_SPAN_EM:
    WBufAppendCStr(r->outbuf, "<em>");
    break;
  case MD_SPAN_STRONG:
    WBufAppendCStr(r->outbuf, "<b>");
    break;
  case MD_SPAN_A:
  ...
  case MD_SPAN_IMG:
    ...
    break;
  case MD_SPAN_CODE:
    WBufAppendCStr(r->outbuf, "<code>");
    break;
  case MD_SPAN_DEL:
    WBufAppendCStr(r->outbuf, "<del>");
    break;
  case MD_SPAN_LATEXMATH:
    WBufAppendCStr(r->outbuf, "<x-equation>");
    break;
  case MD_SPAN_LATEXMATH_DISPLAY:
    WBufAppendCStr(r->outbuf, "<x-equation type=\"display\">");
    break;
...
static int leave_span_callback(MD_SPANTYPE type, void *detail, void *userdata)
{
  ...
  case MD_SPAN_LATEXMATH_DISPLAY:
    ...
    break;
  case MD_SPAN_WIKILINK:
    WBufAppendCStr(r->outbuf, "</x-wikilink>");
    break;
  }
