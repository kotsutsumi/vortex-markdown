import { utf8, withTmpBytePtr, withOutPtr, werrCheck, mallocbuf } from './wlib'
...
export function parse(source, options) {
    ...
    if (options.onCodeBlock) removeFunction(onCodeBlockPtr)
    ...
    if (options.bytes || options.asMemoryView) return outbuf
...
function create_onCodeBlock_fn(onCodeBlock) {
    ...
    const fnptr = addFunction(function (
        metaptr,
        metalen,
        inptr,
        inlen,
